    ...
    return (
        <Form className="d-flex justify-content-center mb-4">
            ...
            <div className="mx-3">
                ...
                <Form.Select id="devLevel-select" onChange={(e)=>props.setDevLevelFilter(e.target.value)} defaultValue={props.devLevelFilter}>
            ...
            <div className="mx-3">
                ...
                <Form.Select id="company-select" onChange={(e)=>props.setCompanyFilter(e.target.value)} defaultValue={props.companyFilter}>
                <option value="">No filter</option>
            ...
            <div className="mx-3">
                ...
                <Form.Select id="genre-select" onChange={(e)=>props.setGenreFilter(e.target.value)} defaultValue={props.genreFilter}>
                <option value="">No filter</option>
